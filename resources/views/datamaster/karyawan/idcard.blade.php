    ...
    <div id="content-section">
        <div class="idcard-container" id="idcard-area">
            ...
            <div class="idcard-body-modern">
                ...
                <div class="idcard-position-modern">Staff Administration</div>
        ...
        <div style="text-align:center; margin: 24px 0 0 0; z-index:2; position:relative;">
            <button id="download-idcard" class="btn btn-success"
                style="background:#8B0000; color:#fff; border:none; border-radius:8px; padding:8px 18px; font-size:1rem; box-shadow:0 2px 8px rgba(50,116,94,0.13);">
