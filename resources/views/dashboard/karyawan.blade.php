...
@section('content')
    <style>
        :root {
            ...
            --bg-nav: #FFF0F5;
            --color-nav: #FFFFFF;
            --color-nav-active: #00CED1;
            --bg-indicator: #DAA520;
            --color-nav-hover: #00BFFF;
        }
    ...
    <div id="app-section">
        <div class="row">
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 5px 5px !important; line-height:0.8rem">
                        <img src="{{ asset('assets/template/img/3d/hadir1.png') }}" alt="" style="width: 50px" class="mb-1">
                        <br>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 5px 5px !important; line-height:0.8rem">
                        <img src="{{ asset('assets/template/img/3d/sakit1.png') }}" alt="" style="width: 50px" class="mb-1">
                        <br>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 5px 5px !important; line-height:0.8rem">
                        <img src="{{ asset('assets/template/img/3d/izin1.png') }}" alt="" style="width: 50px" class="mb-1">
                        <br>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 5px 5px !important; line-height:0.8rem">
                        <img src="{{ asset('assets/template/img/3d/cuti1.jpeg') }}" alt="" style="width: 50px" class="mb-1">
                        <br>
        ...
        <div class="row mt-2">
            <div class="col-3">
                <a href="{{ route('karyawan.idcard', Crypt::encrypt($karyawan->nik)) }}">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 5px 5px !important; line-height:0.8rem">
                            <img src="{{ asset('assets/template/img/3d/idcard1.png') }}" alt="" style="width: 50px" class="mb-0">
                            <br>
